...
class App {
    ...
    _renderWorkout(workout) {
        ...
        <h2 class="workout__title">${workout.description} <span class="workout__delete">❌</span></h2>
        ...
        this.deleteBtn = document.querySelector('.workout__delete');
        this.deleteBtn.addEventListener('click', this._deleteWorkout.bind(this))
    }
